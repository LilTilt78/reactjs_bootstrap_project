...
export const DeleteEvent = () => {
    ...
    return (
      <div className='container'>
        <button type="button" className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#deleteEventModal">Delete Event</button>
        <div className="modal modal fade" id="deleteEventModal" role='dialog'>
